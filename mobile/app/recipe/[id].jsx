...
const RecipeDetail = () => {
  ...
  useEffect(()=>{
    const checkIsSaved = async () =>{
        ...
        try {  
            ...
            const isRecipeSaved = await favourites.some((fav) => fav.recipeId=== parseInt(recipeId))
    ...
    const loadRecipeDetail = async () =>{
        ...
        try {
            ...
            Alert.alert("Error", "Failed to load recipe details. Please try again later.")
        } finally {
            setLoading(false)
        }
    }
  ...
  const handleToggleSave = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Error",
        isSaved ? "Failed to remove recipe from favourites." : "Failed to save recipe."
      )
    } finally {
      setIsSaving(false)
    }
